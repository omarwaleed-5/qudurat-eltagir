package com.eltagir.qudurat;

public class Constant {

    private static String DOMAIN_URL = "https://qudadmin.eltagir.com/"; //domain or admin panel url
    public static String QUIZ_URL = DOMAIN_URL + "api-v2.php";  //api url
    /////// PARAMETERS  ///////
    public static String AUTHORIZATION = "Authorization";
    public static String JWT_KEY = "omar198237645";
    ...
    public static final String DefaultLanguage = "ar";
    ...
    public static int CIRCULAR_MAX_PROGRESS = 600; // max here we set 25 second for each question, you can increase or decrease time here
    public static int TIME_PER_QUESTION = 600000;  //here we set 25 second to milliseconds
    public static int COUNT_DOWN_TIMER = 1000; //here we set 1 second
    public static int MATHASCIRCULAR_MAX_PROGRESS = 600; // max here we set 25 second for each question, you can increase or decrease time here
    public static int TIME_PER_MATHSQUESTION = 600000;  //here we set 25 second to milliseconds
    ...
    public static String JOIN = "انضم";
    ...
    public static String BATTLE = "معركة";
    public static String PRACTICE = "تدرب";
    public static String LEARNINGZONE = "فيديوهات الشرح";
    public static String MATHSZONE = "قسم الكمي";
